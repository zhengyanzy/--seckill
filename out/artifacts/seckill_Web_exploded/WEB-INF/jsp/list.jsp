            ...
            <table class="table table-hover">
                ...
                <c:forEach items="${list}" var="sk">
                    <tr>
                        ...
                        <td>${sk.number}</td>
                        <td>
                            <fmt:parseDate value="${sk.startTime}" var="parsedDateTime" pattern="yyyy-MM-dd" type="BOTH"/>
                            <fmt:formatDate value="${parsedDateTime}" pattern="yyyy-MM-dd" type="BOTH"/>
                        </td>
                        <%--${sk.startTime}格式是xxxx-xx-xx Txx:xx:xx 无法正常解析日期--%>
